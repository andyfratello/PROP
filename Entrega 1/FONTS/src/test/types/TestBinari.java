...
public class TestBinari {
    ...
    public void BinariIntNegatiu() {
        Binari bin = new Binari(-5);
        assertEquals("11111111111111111111111111111011",bin.getValor());
    }
