 ...
 */
public class FuncioVectorDoubles extends Funcio {
    protected Vector<Double> _value = new Vector<Double>();
    ...
    /** Guarda el valor entrat Vector<Double> al valor de l'objecte
     *
     * @param_Vector<Double>
     */

    public void setValueV(Vector<Double> x) {
        _value = x;
