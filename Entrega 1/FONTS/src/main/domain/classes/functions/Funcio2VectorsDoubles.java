...
/**
 * Aquesta classe emmagatzema els valors de dos vectors que despres s'utilitzara en una de les funcions
 * que hereden d'aquesta classe
 * @author Andreu Orensanz Bargalló (andreu.orensanz@estudiantat.upc.edu)
 */
public class Funcio2VectorsDoubles extends Funcio {
    protected Vector<Double> _a = new Vector<Double>();
    protected Vector<Double> _b = new Vector<Double>();
    ...
    /** Guarda els valors entrats Vector<Double> al valor del objecte Covariancia
     *
     * @paramVector<Double>
     */
