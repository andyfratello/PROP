...
/**
 * Aquesta classe emmagatzema el valor LocalDate que despres s'utilitzara en una de les funcions
 * que hereden d'aquesta classe
 * @author Joan Aluja Oraa (joan.aluja@estudiantat.upc.edu)
 */
public class FuncioDate extends Funcio {
    protected LocalDate _value;
    ...
    /**
     * Aquest metode emmagatzema el valor LocalDate que despres s'utilitzara en una de les funcions
     * que hereden d'aquesta
     * @param x
     */
    public void setValueLD(LocalDate x) {
        _value = x;
    }
