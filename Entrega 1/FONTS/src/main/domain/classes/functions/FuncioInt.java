...
/**
 * Aquesta classe emmagatzema el valor int que despres s'utilitzara en una de les funcions
 * que hereden d'aquesta classe
 * @author Joan Aluja Oraa (joan.aluja@estudiantat.upc.edu)
 */
public class FuncioInt extends Funcio {
