...
public class TestInterpret {
    ...
    public void getDouble1() {
        assertEquals(12.14, Interpret.StringToNumber("12.14").doubleValue(), 0.0001);
    }
    ...
    public void getDouble2() {
        Number n = Interpret.StringToNumber("test");
    }
    ...
    @Test
    public void getInt1() {
        assertEquals(1256, Interpret.StringToNumber("1256").intValue());
    }
    ...
    public void getData1() {
        ...
        assertEquals(LocalDate.parse("07/02/2001", formatter), Interpret.StringToDate("07/02/2001"));
    }
    ...
    public void getData2() {
        LocalDate d = Interpret.StringToDate("test");
    }
