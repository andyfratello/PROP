...
import main.domain.classes.functions.numerica.hexadecimalADecimal;
...
public class TestHexadecimalADecimal {
    ...
    public void hexadecimalADecimalPositiu() {
        hexadecimalADecimal had = new hexadecimalADecimal(new NumberT(new Hexadecimal(2678)) );
        assertEquals(2678, had.GetResultat().asNumber().intValue());
    }
    ...
    public void hexadecimalADecimalNegatiu() {
        hexadecimalADecimal had = new hexadecimalADecimal(new NumberT(new Hexadecimal(-9894)));
        assertEquals(-9894, had.GetResultat().asNumber().intValue() );
    }
