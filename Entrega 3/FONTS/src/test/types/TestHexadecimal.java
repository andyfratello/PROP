...
public class TestHexadecimal {
    ...
    public void HexadecimalStringCorrecte() {
        ...
        assertEquals("0x5C", hex.getValor());
    }
    ...
    public void HexadecimalIntNegatiu() {
        Hexadecimal hex = new Hexadecimal(-92);
        assertEquals("0xFFFFFFA4", hex.getValor());
    }
    ...
    @Test
    public void TestMaxHexadecimal() {
        assertEquals(new Hexadecimal(-92), new Hexadecimal("0xFFFFFFFA4") );
        assertEquals(-92, new Hexadecimal("0xFFFFFFFA4").aDecimal());
        assertTrue(Hexadecimal.esHexadecimal("0xFFFFFFFA4"));
    }
