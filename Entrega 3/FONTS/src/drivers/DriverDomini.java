...
public class DriverDomini {
    ...
    private Pair<Integer, Integer> llegirCoords() {
        ...
        String y_string = input.substring(i);
        x = Interpret.HexavigesimalToInteger(x_string);
    ...
    public void testCercaValor() {
        ...
        Vector<Pair<Integer,Integer>> resCela = cd.cercarValorPos(buscar);
        if (resCela.size() <= 0) {
            System.out.println("Valor no trobat!");
        }
        System.out.println("Valors trobats:");
        resCela.forEach(c ->
                System.out.println("Columna: " + c.first() + " Fila: " + c.second() + " -> " + cd.obtenirValorCela(c.first(), c.second())));
    }
    ...
    public void testCopiarCela() {
        ...
        cd.copiarCela(coords.first(), coords.second());
    ...
    public void testTallarCela() {
        ...
        Pair<Integer, Integer> coords = llegirCoords();
        cd.tallarCela(coords.first(), coords.second());
    ...
    public void testCopiarBloc() {
        ...
        cd.copiarBloc(coord1.first(), coord1.second(), coord2.first(), coord2.second());
    ...
    public void testTallarBloc() {
        ...
        System.out.println("Segones coordenades: ");
        Pair<Integer, Integer> coord2 = llegirCoords();
        cd.tallarBloc(coord1.first(), coord1.second(), coord2.first(), coord2.second());
    ...
    public void testEnganxar() {
        ...
        Pair<Integer, Integer> coords = llegirCoords();
        cd.enganxar(coords.first(), coords.second());
    ...
    public void testObtenirValorCela() {
        ...
        Pair<Integer, Integer> coords = llegirCoords();
        String res = cd.obtenirValorCela(coords.first(), coords.second());
    ...
    public void testObtenirValorRealCela() {
        ...
        System.out.println("Introdueix coordenada de la Cela de la que el vol obtenir el valor (pex: A3)");
        Pair<Integer, Integer> coords = llegirCoords();
        String res = cd.obtenirValorRealCela(coords.first(), coords.second());
        System.out.println("Valor: " + res);
    }
    ...
    public void testOrdenarPerColumnes() {
        ...
        System.out.println("Segones coordenades: ");
        Pair<Integer, Integer> coord2 = llegirCoords();
        cd.ordenarBloc(coord1.first(), coord1.second(), coord2.first(), coord2.second());
        System.out.println("Celes ordenades!");
    }

    public void testOrdenarStrings() {
        if (cd == null) {
            System.err.println("Primer s'ha de crear el controlador!");
            return;
        }
        ...
        System.out.println("Segones coordenades: ");
        Pair<Integer, Integer> coord2 = llegirCoords();
        //cd.ordenarStrings(coord1.first(), coord1.second(), coord2.first(), coord2.second());
        System.out.println("Celes ordenades!");
    }
    public void testOrdenarIntegers() {
        if (cd == null) {
            System.err.println("Primer s'ha de crear el controlador!");
            return;
        }
        ...
        System.out.println("Segones coordenades: ");
        Pair<Integer, Integer> coord2 = llegirCoords();
        //cd.ordenarIntegers(coord1.first(), coord1.second(), coord2.first(), coord2.second());
        System.out.println("Celes ordenades!");
    }

    public void testGetNomPathDocumentObert() {
        if (cd == null) {
            System.err.println("Primer s'ha de crear el controlador!");
            return;
        }
        System.out.println("Nom document: " + cd.getNomDocument() + "  Localitzacio Document: " + cd.getPathDocument());
    }
    ...
    */
    ...
    public void testSetFullActiu() {
        ...
        List<Integer> llista = cd.getIDsFulls();
    ...
    public void testObtenirCela() {
        ...
        System.out.println("Valor Usuari Cela: " + c.GetValorUsuari());
    }
    */
    ...
    public void testModificarCela() {
        ...
        String input = in.nextLine();
        cd.modificarCela(coords.first(), coords.second(), input);
    ...
    public void testAfegirFila() {
        ...
        System.out.println("Introdueix la posicio on vols afegir una fila (0.." + (cd.getNumFiles()) + ")");
        int pos = in.nextInt();
        cd.afegirFila(pos);
    ...
    public void testAfegirColumna() {
        ...
        System.out.println("Introdueix la posicio on vols afegir una columna (0.." + (cd.getNumColumnes()) + ")");
        int pos = in.nextInt();
    ...
    public void testEliminarFila() {
        ...
        System.out.println("Introdueix la posicio de la fila que vols eliminar (0.." + (cd.getNumFiles() - 1) + ")");
        int pos = in.nextInt();
        cd.eliminarFila(pos);
    ...
    public void testEliminarColumna() {
        ...
        System.out.println("Introdueix la posicio de la columna que vols eliminar (0.." + (cd.getNumColumnes() - 1) + ")");
        int pos = in.nextInt();
    ...
    public void testReemplacarValor() {
        ...
        cd.reemplacarValor(coord1.first(), coord1.second(), coord2.first(), coord2.second(), cerca, reemplac);
    ...
    public void testConfig() {
        ...
        System.out.println("Mostrant documents recents: ");
        Vector<Vector<String>> res = cd.obtenirConfig();
        res.forEach(element ->
                System.out.println(element.get(0) + "    " + element.get(1) + "    " + element.get(2)));
    }

    // Afegir num full seleccionable
    public void testGuardaCSV() {
        System.out.println("Introdueix l'ID del Full a exportar: ");
        int idF = in.nextInt();
        cd.guardaCSV(idF);
        System.out.println("CSV exportat en: " + cd.getPathDocument());
    }

    public void testCarregaCSV() {
        cd = new CtrlDomini();
        System.out.println("Introdueix el path del CSV: ");
        String path = in.nextLine();
        cd.carregaCSV(path);
        System.out.println("CSV carregat desde: " + cd.getPathDocument());
    }
    // Afegir num full seleccionable
    public void testGuardaDoc() {
        System.out.println("Guardant document...");
        cd.guardaDocument();
        System.out.println("Document guardat a: " + cd.getPathDocument());
    }

    public void testCarregaDoc() {
        cd = new CtrlDomini();
        System.out.println("Introdueix el path del document: ");
        String path = in.nextLine();
        cd.carregaDocument(path);
        System.out.println("Document carregat desde: " + cd.getPathDocument());
    }
    ...
    public static void main (String [] args) throws Exception {
        ...
        while (!input.equals("0") && !input.equals("sortir")) {
            switch (input) {
                ...
                case "11":
                case "ordenarIntegers": {
                    dd.testOrdenarIntegers();
                    break;
                }
                case "12":
                case "ordenarStrings": {
                    dd.testOrdenarStrings();
                    break;
                }
                case "13":
                case "getDocumentObert": {
                    dd.testGetNomPathDocumentObert();
                    break;
                }
                case "14":
                case "setFullActiu": {
    ...
    private static void mostra_metodes() {
        ...
        System.out.println("(11|ordenarIntegers) - Ordena un bloc d'Enters");
        System.out.println("(12|ordenarStrings) - Ordena un bloc de Strings");
        System.out.println("(13|getDocumentObert) - Get Document Obert");
        System.out.println("(14|setFullActiu) - Set Full Actiu");
        System.out.println("(15|crearDocument) - Crear Document");
        System.out.println("(16|tancarDocument) - Tancar Document");
        //System.out.println("DEPRECATED! (16|obtenirCela) - Obtenir Cela");
        ...
        System.out.println("(27|config) - Obtenir configuracio");
        System.out.println("(28|exportarCSV) - Exportar full CSV");
        System.out.println("(29|importarCSV) - Importar full CSV");
        System.out.println("(30|guardarDocumet) - Guarda el document actual");
        System.out.println("(31|carregarDocument) - Carrega el document especificat");
        System.out.println();
